...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 04, 2023 lúc 08:51 AM
...
(54, 'Kem Dưỡng Retinol Cold Lift (1%) Chống Lão Hóa, Giảm Thiểu Nếp Nhăn, Làm Săn Chắc Và Cho Da Rạng Rỡ ', '30.jpg', 150000, 130000, 1, 122, '', 1, 'Tạm ngưng'),
(55, 'Tinh Chất Chống Oxy Hoá, Bổ Sung Dưỡng Chất Phiên Bản MD Osmosis REPLENISH MD Antoxidant Infusion Se', '31.png', 300000, 150000, 3, 30, NULL, NULL, 'Đang hoạt động'),
(56, 'Sáp Dưỡng Phục Hồi Da Phiên Bản MD Osmosis REMEDY MD Healing Balm 30ml', '32.png', 300000, 150000, 3, 30, NULL, NULL, 'Đang hoạt động'),
(57, 'Minerals Fx350 Uber Finishing – Phấn Lót Giúp Kiểm Soát Dầu, Cải Thiện Lỗ Chân Lông', '33.jpg', 300000, 150000, 3, 30, NULL, NULL, 'Đang hoạt động'),
(58, 'Bioderma Sebium Sensitive – Kem Dưỡng Da Dành Cho Da Mụn, Yếu Và Nhạy Cảm – 30ml', '1.png', 620000, 500000, 1, 100, NULL, 0, 'Đang hoạt động'),
(59, 'Balance Active Formula Gold Collagen Rejuvenating Serum – Tinh Chất Vàng Dưỡng Căng Bóng Da, Ngừa Lã', '2.jpeg', 450000, 400000, 1, 50, '', 0, 'Đang hoạt động'),
(60, 'SuzanObagiMD Physical Defense Broad Spectrum SPF 40 – Kem Chống Nắng Vật Lý Đến Từ Mỹ 96.3 G', '12.jpg', 550000, 450000, 1, 50, '', 1, 'Đang hoạt động'),
(61, 'Priori TTC Natural Soothing Balm – Sáp Dưỡng Ẩm, Làm Dịu Da 20gr/ 90gr', '24.jpg', 300000, 240000, 3, 30, '', 1, 'Đang hoạt động'),
(62, 'Kem Dưỡng Retinol Cold Lift (1%) Chống Lão Hóa, Giảm Thiểu Nếp Nhăn, Làm Săn Chắc Và Cho Da Rạng Rỡ ', '30.jpg', 150000, 130000, 1, 122, '', 1, 'Tạm ngưng'),
(63, 'Tinh Chất Chống Oxy Hoá, Bổ Sung Dưỡng Chất Phiên Bản MD Osmosis REPLENISH MD Antoxidant Infusion Se', '31.png', 300000, 150000, 3, 30, NULL, NULL, 'Đang hoạt động'),
(64, 'Mesoestetic Mineral Matt Antiaging Fluid Mesoprotech SPF 50+- Kem Chống Nắng Thế Hệ Mới 50ml', '6.png', 450000, 330000, 2, 30, NULL, NULL, 'Đang hoạt động'),
(65, 'Sáp Dưỡng Phục Hồi Da Phiên Bản MD Osmosis REMEDY MD Healing Balm 30ml', '32.png', 300000, 150000, 3, 30, NULL, NULL, 'Đang hoạt động');
...
--
ALTER TABLE `sanpham`
  MODIFY `MaSanPham` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
